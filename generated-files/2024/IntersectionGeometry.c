...
asn_TYPE_member_t asn_MBR_IntersectionGeometry_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct IntersectionGeometry, preemptPriorityData),
	...
	{ ATF_POINTER, 2, offsetof(struct IntersectionGeometry, regional),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_regional_10,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct IntersectionGeometry, roadAuthorityID),
...
static const int asn_MAP_IntersectionGeometry_oms_1[] = { 0, 4, 5, 7, 8, 9 };
...
static const asn_TYPE_tag2member_t asn_MAP_IntersectionGeometry_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* roadAuthorityID */
};
