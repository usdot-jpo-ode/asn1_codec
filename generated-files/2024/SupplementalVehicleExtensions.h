...
typedef struct SupplementalVehicleExtensions {
	...
	struct WeatherReport	*doNotUse1;	/* OPTIONAL */
	struct WeatherProbe	*doNotUse2;	/* OPTIONAL */
	struct ObstacleDetection	*doNotUse3;	/* OPTIONAL */
	struct DisabledVehicle	*status;	/* OPTIONAL */
	struct SpeedProfile	*doNotUse4;	/* OPTIONAL */
	struct RTCMPackage	*doNotUse5;	/* OPTIONAL */
