...
static asn_oer_constraints_t asn_OER_memb_trailerAxles_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_trailerAxles_constr_3 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_TrailerDetails_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TrailerDetails, trailerAxles),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_trailerAxles_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_trailerAxles_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
