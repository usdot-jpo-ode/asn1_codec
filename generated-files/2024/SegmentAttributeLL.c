 ...
 * 	found in "./j2735-asn-files/2024/J2735-TravelerInformation-2024-rel-v1.1.2.asn"
...
static asn_oer_constraints_t asn_OER_type_SegmentAttributeLL_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_SegmentAttributeLL_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  6,  6,  0,  37 }	/* (0..37,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_SegmentAttributeLL_value2enum_1[] = {
	{ 0,	8,	"reserved" },
	{ 1,	10,	"doNotBlock" },
	{ 2,	9,	"whiteLine" },
...
static const unsigned int asn_MAP_SegmentAttributeLL_enum2value_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_SegmentAttributeLL_specs_1 = {
	asn_MAP_SegmentAttributeLL_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_SegmentAttributeLL_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_SegmentAttributeLL_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_SegmentAttributeLL = {
	"SegmentAttributeLL",
	"SegmentAttributeLL",
	&asn_OP_NativeEnumerated,
	asn_DEF_SegmentAttributeLL_tags_1,
	sizeof(asn_DEF_SegmentAttributeLL_tags_1)
		/sizeof(asn_DEF_SegmentAttributeLL_tags_1[0]), /* 1 */
	asn_DEF_SegmentAttributeLL_tags_1,	/* Same as above */
	sizeof(asn_DEF_SegmentAttributeLL_tags_1)
		/sizeof(asn_DEF_SegmentAttributeLL_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_SegmentAttributeLL_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_SegmentAttributeLL_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_SegmentAttributeLL_specs_1	/* Additional specs */
};
