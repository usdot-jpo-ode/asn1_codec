 ...
 * From ASN.1 module "IntersectionCollision"
 * 	found in "./j2735-asn-files/2024/J2735-IntersectionCollision-2024-rel-v1.1.asn"
...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_11 = {
	sizeof(struct IntersectionCollision__regional),
	offsetof(struct IntersectionCollision__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_IntersectionCollision_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct IntersectionCollision, timeStamp),
	...
	{ ATF_POINTER, 3, offsetof(struct IntersectionCollision, partOne),
	...
	{ ATF_POINTER, 2, offsetof(struct IntersectionCollision, path),
	...
	{ ATF_POINTER, 1, offsetof(struct IntersectionCollision, pathPrediction),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IntersectionCollision, intersectionID),
	...
	{ ATF_POINTER, 1, offsetof(struct IntersectionCollision, regional),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_regional_11,
		0,
...
static const int asn_MAP_IntersectionCollision_oms_1[] = { 2, 3, 4, 5, 9 };
static const ber_tlv_tag_t asn_DEF_IntersectionCollision_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_IntersectionCollision_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* msgCnt */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* id */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* timeStamp */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* partOne */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* path */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* pathPrediction */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* intersectionID */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* laneNumber */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* eventFlag */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* regional */
};
asn_SEQUENCE_specifics_t asn_SPC_IntersectionCollision_specs_1 = {
