...
static asn_oer_constraints_t asn_OER_type_TravelerInfoType_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_TravelerInfoType_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  3 }	/* (0..3,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_TravelerInfoType_value2enum_1[] = {
	{ 0,	7,	"unknown" },
	{ 1,	8,	"advisory" },
	{ 2,	11,	"roadSignage" },
...
static const unsigned int asn_MAP_TravelerInfoType_enum2value_1[] = {
	1,	/* advisory(1) */
...
const asn_INTEGER_specifics_t asn_SPC_TravelerInfoType_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_TravelerInfoType_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_TravelerInfoType = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_TravelerInfoType_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_TravelerInfoType_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
