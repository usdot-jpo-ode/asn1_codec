...
asn_TYPE_member_t asn_MBR_EcdsaP384Signature_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EcdsaP384Signature, sSig),
...
static const ber_tlv_tag_t asn_DEF_EcdsaP384Signature_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EcdsaP384Signature_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rSig */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* sSig */
};
asn_SEQUENCE_specifics_t asn_SPC_EcdsaP384Signature_specs_1 = {
	sizeof(struct EcdsaP384Signature),
	offsetof(struct EcdsaP384Signature, _asn_ctx),
	asn_MAP_EcdsaP384Signature_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EcdsaP384Signature = {
	"EcdsaP384Signature",
	"EcdsaP384Signature",
	&asn_OP_SEQUENCE,
	asn_DEF_EcdsaP384Signature_tags_1,
