...
oer_type_decoder_f CoefficientOfFriction_decode_oer;
oer_type_encoder_f CoefficientOfFriction_encode_oer;
per_type_decoder_f CoefficientOfFriction_decode_uper;
per_type_encoder_f CoefficientOfFriction_encode_uper;
per_type_decoder_f CoefficientOfFriction_decode_aper;
per_type_encoder_f CoefficientOfFriction_encode_aper;
