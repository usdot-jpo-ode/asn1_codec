...
asn_TYPE_member_t asn_MBR_VehicleToLanePosition_1[] = {
...
static const ber_tlv_tag_t asn_DEF_VehicleToLanePosition_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_VehicleToLanePosition_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* stationID */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* laneID */
};
asn_SEQUENCE_specifics_t asn_SPC_VehicleToLanePosition_specs_1 = {
