 ...
 * 	found in "./j2735-asn-files/2024/J2735-SignalRequestMessage-2024-rel-v1.1.asn"
...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_7 = {
	sizeof(struct SignalRequestMessage__regional),
	offsetof(struct SignalRequestMessage__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SignalRequestMessage_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignalRequestMessage, second),
	...
	{ ATF_POINTER, 2, offsetof(struct SignalRequestMessage, sequenceNumber),
	...
	{ ATF_POINTER, 1, offsetof(struct SignalRequestMessage, requests),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignalRequestMessage, requestor),
	...
	{ ATF_POINTER, 1, offsetof(struct SignalRequestMessage, regional),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_regional_7,
		0,
...
static const int asn_MAP_SignalRequestMessage_oms_1[] = { 0, 2, 3, 5 };
static const ber_tlv_tag_t asn_DEF_SignalRequestMessage_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SignalRequestMessage_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_SignalRequestMessage_specs_1 = {
	...
	asn_MAP_SignalRequestMessage_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
	6,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_SignalRequestMessage = {
	"SignalRequestMessage",
	"SignalRequestMessage",
	&asn_OP_SEQUENCE,
	asn_DEF_SignalRequestMessage_tags_1,
	sizeof(asn_DEF_SignalRequestMessage_tags_1)
		/sizeof(asn_DEF_SignalRequestMessage_tags_1[0]), /* 1 */
	asn_DEF_SignalRequestMessage_tags_1,	/* Same as above */
	sizeof(asn_DEF_SignalRequestMessage_tags_1)
		/sizeof(asn_DEF_SignalRequestMessage_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	6,	/* Elements count */
	&asn_SPC_SignalRequestMessage_specs_1	/* Additional specs */
};
