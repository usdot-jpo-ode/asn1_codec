...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_ExitService_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_ExitService_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ExitService__Member__item, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ExitService__Member__item, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct ExitService__Member__item),
	offsetof(struct ExitService__Member__item, _asn_ctx),
	offsetof(struct ExitService__Member__item, present),
	sizeof(((struct ExitService__Member__item *)0)->present),
...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ExitService__Member, item),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
asn_TYPE_member_t asn_MBR_ExitService_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_Member_2,
...
static const ber_tlv_tag_t asn_DEF_ExitService_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_ExitService_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ExitService = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ExitService_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ExitService_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
