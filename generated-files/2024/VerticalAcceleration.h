...
oer_type_decoder_f VerticalAcceleration_decode_oer;
oer_type_encoder_f VerticalAcceleration_encode_oer;
per_type_decoder_f VerticalAcceleration_decode_uper;
per_type_encoder_f VerticalAcceleration_encode_uper;
per_type_decoder_f VerticalAcceleration_decode_aper;
per_type_encoder_f VerticalAcceleration_encode_aper;
