...
asn_TYPE_member_t asn_MBR_TravelerDataFrame_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, doNotUse1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SSPindex,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, durationTime),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, doNotUse2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, doNotUse3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, doNotUse4),
	...
	{ ATF_POINTER, 2, offsetof(struct TravelerDataFrame, url),
	...
	{ ATF_POINTER, 1, offsetof(struct TravelerDataFrame, contentNew),
...
static const int asn_MAP_TravelerDataFrame_oms_1[] = { 3, 12, 13 };
...
static const asn_TYPE_tag2member_t asn_MAP_TravelerDataFrame_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* doNotUse1 */
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* durationTime */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* priority */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* doNotUse2 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* regions */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* doNotUse3 */
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 }, /* doNotUse4 */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 }, /* content */
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 12, 0, 0 }, /* url */
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 13, 0, 0 } /* contentNew */
};
