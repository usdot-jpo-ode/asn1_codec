...
int
VerticalAcceleration_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_per_constraints_t asn_PER_type_VerticalAcceleration_constr_1 CC_NOTUSED = {
