...
asn_TYPE_member_t asn_MBR_IntersectionState_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct IntersectionState, maneuverAssistList),
	...
	{ ATF_POINTER, 2, offsetof(struct IntersectionState, regional),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_regional_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct IntersectionState, roadAuthorityID),
...
static const int asn_MAP_IntersectionState_oms_1[] = { 0, 4, 5, 6, 8, 9, 10 };
...
static const asn_TYPE_tag2member_t asn_MAP_IntersectionState_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 } /* roadAuthorityID */
};
