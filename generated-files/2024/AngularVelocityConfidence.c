...
asn_TYPE_member_t asn_MBR_AngularVelocityConfidence_1[] = {
	{ ATF_POINTER, 2, offsetof(struct AngularVelocityConfidence, pitchRateConfidence),
	...
	{ ATF_POINTER, 1, offsetof(struct AngularVelocityConfidence, rollRateConfidence),
...
static const int asn_MAP_AngularVelocityConfidence_oms_1[] = { 0, 1 };
...
static const asn_TYPE_tag2member_t asn_MAP_AngularVelocityConfidence_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pitchRateConfidence */
...
asn_SEQUENCE_specifics_t asn_SPC_AngularVelocityConfidence_specs_1 = {
	...
	asn_MAP_AngularVelocityConfidence_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
