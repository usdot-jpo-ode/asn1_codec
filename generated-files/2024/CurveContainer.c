...
asn_TYPE_member_t asn_MBR_CurveContainer_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct CurveContainer, surfaceCondition),
	...
	{ ATF_POINTER, 3, offsetof(struct CurveContainer, minRadius),
	...
	{ ATF_POINTER, 2, offsetof(struct CurveContainer, bankAngle),
...
static const int asn_MAP_CurveContainer_oms_1[] = { 1, 2, 3, 4 };
...
static const asn_TYPE_tag2member_t asn_MAP_CurveContainer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* advisorySpeed */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* surfaceCondition */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* minRadius */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* bankAngle */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* curveRegion */
};
