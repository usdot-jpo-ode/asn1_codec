 ...
 * From ASN.1 module "TestMessage00"
...
static const asn_TYPE_tag2member_t asn_MAP_TestMessage00_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* header */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* regional */
};
asn_SEQUENCE_specifics_t asn_SPC_TestMessage00_specs_1 = {
	sizeof(struct TestMessage00),
...
asn_TYPE_descriptor_t asn_DEF_TestMessage00 = {
	"TestMessage00",
	"TestMessage00",
	&asn_OP_SEQUENCE,
	asn_DEF_TestMessage00_tags_1,
	sizeof(asn_DEF_TestMessage00_tags_1)
		/sizeof(asn_DEF_TestMessage00_tags_1[0]), /* 1 */
	asn_DEF_TestMessage00_tags_1,	/* Same as above */
	sizeof(asn_DEF_TestMessage00_tags_1)
		/sizeof(asn_DEF_TestMessage00_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_TestMessage00_1,
	2,	/* Elements count */
	&asn_SPC_TestMessage00_specs_1	/* Additional specs */
};
