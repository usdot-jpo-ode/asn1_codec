...
asn_TYPE_member_t asn_MBR_DetectedObstacleData_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DetectedObstacleData, obstSize),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DetectedObstacleData, obstSizeConfidence),
...
static const asn_TYPE_tag2member_t asn_MAP_DetectedObstacleData_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* obstSize */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* obstSizeConfidence */
};
