...
static const long asn_VAL_3_p2pcd8ByteLearningRequestId = 1;
static const asn_ioc_cell_t asn_IOS_Ieee1609HeaderInfoExtensions_1_rows[] = {
	{ "&extId", aioc__value, &asn_DEF_ExtId, &asn_VAL_3_p2pcd8ByteLearningRequestId },
	{ "&ExtContent", aioc__type, &asn_DEF_HashedId8 }
};
static const asn_ioc_set_t asn_IOS_Ieee1609HeaderInfoExtensions_1[] = {
	{ 1, 2, asn_IOS_Ieee1609HeaderInfoExtensions_1_rows }
};
static int
...
static asn_type_selector_result_t
select_Ieee1609HeaderInfoExtensions_content_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_Ieee1609HeaderInfoExtensions_1;
	size_t constraining_column = 0; /* &extId */
	size_t for_column = 1; /* &ExtContent */
	size_t row, presence_index = 0;
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct Ieee1609HeaderInfoExtensions, id));
...
static int
memb_content_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_content_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_content_constr_6 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_TYPE_tag2member_t asn_MAP_content_tag2el_3[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (5 << 2)), 0, 0, 1 }, /* EtsiTs102941CrlRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (5 << 2)), 1, -1, 0 } /* EtsiTs102941DeltaCtlRequest */
};
...
static asn_TYPE_member_t asn_MBR_content_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Ieee1609HeaderInfoExtensions__content, choice.HashedId8),
...
static const asn_TYPE_tag2member_t asn_MAP_content_tag2el_6[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 0, 0, 0 } /* HashedId8 */
};
static asn_CHOICE_specifics_t asn_SPC_content_specs_6 = {
	sizeof(struct Ieee1609HeaderInfoExtensions__content),
	offsetof(struct Ieee1609HeaderInfoExtensions__content, _asn_ctx),
	offsetof(struct Ieee1609HeaderInfoExtensions__content, present),
	sizeof(((struct Ieee1609HeaderInfoExtensions__content *)0)->present),
	asn_MAP_content_tag2el_6,
	1,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_content_6 = {
	"content",
	"content",
	&asn_OP_OPEN_TYPE,
	0,	/* No effective tags (pointer) */
	...
	asn_MBR_content_6,
	1,	/* Elements count */
	&asn_SPC_content_specs_6	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_Ieee1609HeaderInfoExtensions_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Ieee1609HeaderInfoExtensions, id),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ExtId,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_id_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_id_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_id_constraint_4
		},
		0, 0, /* No default value */
		"id"
		},
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct Ieee1609HeaderInfoExtensions, content),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_content_6,
		select_Ieee1609HeaderInfoExtensions_content_type,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_content_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_content_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_content_constraint_4
		},
		0, 0, /* No default value */
		"content"
		},
};
static const ber_tlv_tag_t asn_DEF_Ieee1609HeaderInfoExtensions_tags_4[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Ieee1609HeaderInfoExtensions_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* id */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* content */
};
asn_SEQUENCE_specifics_t asn_SPC_Ieee1609HeaderInfoExtensions_specs_4 = {
	sizeof(struct Ieee1609HeaderInfoExtensions),
	offsetof(struct Ieee1609HeaderInfoExtensions, _asn_ctx),
	asn_MAP_Ieee1609HeaderInfoExtensions_tag2el_4,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_Ieee1609HeaderInfoExtensions = {
	"Ieee1609HeaderInfoExtensions",
	"Ieee1609HeaderInfoExtensions",
	&asn_OP_SEQUENCE,
	asn_DEF_Ieee1609HeaderInfoExtensions_tags_4,
	sizeof(asn_DEF_Ieee1609HeaderInfoExtensions_tags_4)
		/sizeof(asn_DEF_Ieee1609HeaderInfoExtensions_tags_4[0]), /* 1 */
	asn_DEF_Ieee1609HeaderInfoExtensions_tags_4,	/* Same as above */
	sizeof(asn_DEF_Ieee1609HeaderInfoExtensions_tags_4)
		/sizeof(asn_DEF_Ieee1609HeaderInfoExtensions_tags_4[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
