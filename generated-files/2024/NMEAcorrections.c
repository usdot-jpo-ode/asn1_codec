 ...
 * 	found in "./j2735-asn-files/2024/J2735-NMEAcorrections-2024-rel-v1.1.asn"
...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_7 = {
	sizeof(struct NMEAcorrections__regional),
	offsetof(struct NMEAcorrections__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_NMEAcorrections_1[] = {
	{ ATF_POINTER, 4, offsetof(struct NMEAcorrections, timeStamp),
	...
	{ ATF_POINTER, 3, offsetof(struct NMEAcorrections, rev),
	...
	{ ATF_POINTER, 2, offsetof(struct NMEAcorrections, msg),
	...
	{ ATF_POINTER, 1, offsetof(struct NMEAcorrections, wdCount),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NMEAcorrections, payload),
	...
	{ ATF_POINTER, 1, offsetof(struct NMEAcorrections, regional),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_regional_7,
		0,
...
static const int asn_MAP_NMEAcorrections_oms_1[] = { 0, 1, 2, 3, 5 };
static const ber_tlv_tag_t asn_DEF_NMEAcorrections_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NMEAcorrections_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NMEAcorrections_specs_1 = {
	sizeof(struct NMEAcorrections),
	offsetof(struct NMEAcorrections, _asn_ctx),
	asn_MAP_NMEAcorrections_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_NMEAcorrections_oms_1,	/* Optional members */
	5, 0,	/* Root/Additions */
	6,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NMEAcorrections = {
	"NMEAcorrections",
	"NMEAcorrections",
	&asn_OP_SEQUENCE,
	asn_DEF_NMEAcorrections_tags_1,
	sizeof(asn_DEF_NMEAcorrections_tags_1)
		/sizeof(asn_DEF_NMEAcorrections_tags_1[0]), /* 1 */
	asn_DEF_NMEAcorrections_tags_1,	/* Same as above */
	sizeof(asn_DEF_NMEAcorrections_tags_1)
		/sizeof(asn_DEF_NMEAcorrections_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	6,	/* Elements count */
	&asn_SPC_NMEAcorrections_specs_1	/* Additional specs */
};
