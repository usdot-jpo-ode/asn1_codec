...
asn_TYPE_member_t asn_MBR_ToBeSignedLinkageValueCrl_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct ToBeSignedLinkageValueCrl, individual),
	...
	{ ATF_POINTER, 2, offsetof(struct ToBeSignedLinkageValueCrl, groups),
	...
	{ ATF_POINTER, 1, offsetof(struct ToBeSignedLinkageValueCrl, groupsSingleSeed),
...
static const int asn_MAP_ToBeSignedLinkageValueCrl_oms_1[] = { 2, 3, 4 };
