...
select_AppExtension_content_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_SetCertExtensions_1;
	size_t constraining_column = 0; /* &id */
	size_t for_column = 1; /* &App */
	size_t row, presence_index = 0;
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct AppExtension, id));
...
static asn_TYPE_member_t asn_MBR_content_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct AppExtension__content, choice.OperatingOrganizationId),
...
static asn_CHOICE_specifics_t asn_SPC_content_specs_3 = {
	sizeof(struct AppExtension__content),
	offsetof(struct AppExtension__content, _asn_ctx),
	offsetof(struct AppExtension__content, present),
	sizeof(((struct AppExtension__content *)0)->present),
...
asn_TYPE_member_t asn_MBR_AppExtension_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct AppExtension, id),
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct AppExtension, content),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_content_3,
		select_AppExtension_content_type,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
...
static const ber_tlv_tag_t asn_DEF_AppExtension_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_AppExtension_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* id */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* content */
};
asn_SEQUENCE_specifics_t asn_SPC_AppExtension_specs_1 = {
	sizeof(struct AppExtension),
	offsetof(struct AppExtension, _asn_ctx),
	asn_MAP_AppExtension_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_AppExtension = {
	"AppExtension",
	"AppExtension",
	&asn_OP_SEQUENCE,
	asn_DEF_AppExtension_tags_1,
	sizeof(asn_DEF_AppExtension_tags_1)
		/sizeof(asn_DEF_AppExtension_tags_1[0]), /* 1 */
	asn_DEF_AppExtension_tags_1,	/* Same as above */
	sizeof(asn_DEF_AppExtension_tags_1)
		/sizeof(asn_DEF_AppExtension_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_AppExtension_1,
	2,	/* Elements count */
	&asn_SPC_AppExtension_specs_1	/* Additional specs */
};
