...
asn_TYPE_member_t asn_MBR_ToBeSignedCertificate_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct ToBeSignedCertificate, flags),
	...
	{ ATF_POINTER, 3, offsetof(struct ToBeSignedCertificate, appExtensions),
	...
	{ ATF_POINTER, 2, offsetof(struct ToBeSignedCertificate, certIssueExtensions),
	...
	{ ATF_POINTER, 1, offsetof(struct ToBeSignedCertificate, certRequestExtension),
...
static const int asn_MAP_ToBeSignedCertificate_oms_1[] = { 4, 5, 6, 7, 8, 9, 10, 12, 13, 14, 15 };
