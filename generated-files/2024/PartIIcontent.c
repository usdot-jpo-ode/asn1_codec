...
static const asn_ioc_cell_t asn_IOS_BSMpartIIExtension_1_rows[] = {
	...
	{ "&id", aioc__value, &asn_DEF_BasicSafetyMessage_PartII_Id, &asn_VAL_2_specialVehicleExt },
	{ "&Type", aioc__type, &asn_DEF_SpecialVehicleExtensions },
	{ "&id", aioc__value, &asn_DEF_BasicSafetyMessage_PartII_Id, &asn_VAL_3_supplementalVehicleExt },
...
select_BSMpartIIExtension_partII_Value_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_BSMpartIIExtension_1;
	size_t constraining_column = 0; /* &id */
	size_t for_column = 1; /* &Type */
	size_t row, presence_index = 0;
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct BSMpartIIExtension, partII_Id));
...
static asn_TYPE_member_t asn_MBR_partII_Value_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BSMpartIIExtension__partII_Value, choice.VehicleSafetyExtensions),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct BSMpartIIExtension__partII_Value, choice.SpecialVehicleExtensions),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct BSMpartIIExtension__partII_Value, choice.SupplementalVehicleExtensions),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_partII_Value_specs_3 = {
	sizeof(struct BSMpartIIExtension__partII_Value),
	offsetof(struct BSMpartIIExtension__partII_Value, _asn_ctx),
	offsetof(struct BSMpartIIExtension__partII_Value, present),
	sizeof(((struct BSMpartIIExtension__partII_Value *)0)->present),
...
asn_TYPE_member_t asn_MBR_BSMpartIIExtension_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BSMpartIIExtension, partII_Id),
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct BSMpartIIExtension, partII_Value),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_partII_Value_3,
		select_BSMpartIIExtension_partII_Value_type,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
...
static const ber_tlv_tag_t asn_DEF_BSMpartIIExtension_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_BSMpartIIExtension_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* partII-Id */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* partII-Value */
};
asn_SEQUENCE_specifics_t asn_SPC_BSMpartIIExtension_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_BSMpartIIExtension = {
	...
	"BSMpartIIExtension",
	&asn_OP_SEQUENCE,
	asn_DEF_BSMpartIIExtension_tags_1,
	sizeof(asn_DEF_BSMpartIIExtension_tags_1)
		/sizeof(asn_DEF_BSMpartIIExtension_tags_1[0]), /* 1 */
	asn_DEF_BSMpartIIExtension_tags_1,	/* Same as above */
	sizeof(asn_DEF_BSMpartIIExtension_tags_1)
		/sizeof(asn_DEF_BSMpartIIExtension_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
