...
static asn_oer_constraints_t asn_OER_type_ITIS_IncidentResponseEquipment_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_ITIS_IncidentResponseEquipment_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  7,  7,  0,  71 }	/* (0..71,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_ITIS_IncidentResponseEquipment_value2enum_1[] = {
...
static const unsigned int asn_MAP_ITIS_IncidentResponseEquipment_enum2value_1[] = {
	34,	/* aLS-unit(10060) */
	2,	/* aircraft(9988) */
...
const asn_INTEGER_specifics_t asn_SPC_ITIS_IncidentResponseEquipment_specs_1 = {
	asn_MAP_ITIS_IncidentResponseEquipment_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_ITIS_IncidentResponseEquipment_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_ITIS_IncidentResponseEquipment_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_ITIS_IncidentResponseEquipment = {
	"IncidentResponseEquipment",
	"IncidentResponseEquipment",
	&asn_OP_NativeEnumerated,
	asn_DEF_ITIS_IncidentResponseEquipment_tags_1,
	sizeof(asn_DEF_ITIS_IncidentResponseEquipment_tags_1)
		/sizeof(asn_DEF_ITIS_IncidentResponseEquipment_tags_1[0]), /* 1 */
	asn_DEF_ITIS_IncidentResponseEquipment_tags_1,	/* Same as above */
	sizeof(asn_DEF_ITIS_IncidentResponseEquipment_tags_1)
		/sizeof(asn_DEF_ITIS_IncidentResponseEquipment_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ITIS_IncidentResponseEquipment_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ITIS_IncidentResponseEquipment_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ITIS_IncidentResponseEquipment_specs_1	/* Additional specs */
};
