...
int
GroupID_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const TemporaryID_t *st = (const TemporaryID_t *)sptr;
	size_t size;
...
/*
 * This type is implemented using TemporaryID,
...
asn_per_constraints_t asn_PER_type_GroupID_constr_1 CC_NOTUSED = {
