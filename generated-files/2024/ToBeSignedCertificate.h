...
typedef enum ToBeSignedCertificate__flags {
	ToBeSignedCertificate__flags_usesCubk	= 0
...
struct SequenceOfAppExtensions;
struct SequenceOfCertIssueExtensions;
struct SequenceOfCertRequestExtensions;
...
typedef struct ToBeSignedCertificate {
	...
	struct SequenceOfAppExtensions	*appExtensions;
	struct SequenceOfCertIssueExtensions	*certIssueExtensions;
	struct SequenceOfCertRequestExtensions	*certRequestExtension;
...
extern asn_TYPE_member_t asn_MBR_ToBeSignedCertificate_1[16];
