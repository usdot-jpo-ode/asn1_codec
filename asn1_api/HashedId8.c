...
int
HashedId8_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_HashedId8_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
asn_per_constraints_t asn_PER_type_HashedId8_constr_1 GCC_NOTUSED = {
