...
static asn_TYPE_member_t asn_MBR_TestMessage05_1[] = {
	{ ATF_POINTER, 2, offsetof(struct TestMessage05, header),
...
static const int asn_MAP_TestMessage05_oms_1[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_TestMessage05_specs_1 = {
