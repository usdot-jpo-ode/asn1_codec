 ...
 */
static asn_oer_constraints_t asn_OER_type_DriveAxleLubePressure_constr_1 GCC_NOTUSED = {
	{ 1, 1 }	/* (0..250) */,
	-1};
asn_per_constraints_t asn_PER_type_DriveAxleLubePressure_constr_1 GCC_NOTUSED = {
