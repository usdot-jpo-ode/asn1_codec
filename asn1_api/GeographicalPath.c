...
static asn_oer_constraints_t asn_OER_type_description_constr_9 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_regional_constr_14 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_oer_constraints_t asn_OER_memb_regional_constr_14 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_TYPE_member_t asn_MBR_description_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct description, choice.path),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct description, choice.geometry),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct description, choice.oldRegion),
