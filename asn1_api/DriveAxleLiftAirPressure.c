 ...
 */
static asn_oer_constraints_t asn_OER_type_DriveAxleLiftAirPressure_constr_1 GCC_NOTUSED = {
	{ 2, 1 }	/* (0..1000) */,
	-1};
asn_per_constraints_t asn_PER_type_DriveAxleLiftAirPressure_constr_1 GCC_NOTUSED = {
