 ...
 */
static asn_oer_constraints_t asn_OER_type_TireTemp_constr_1 GCC_NOTUSED = {
	{ 4, 0 }	/* (-8736..55519) */,
	-1};
asn_per_constraints_t asn_PER_type_TireTemp_constr_1 GCC_NOTUSED = {
