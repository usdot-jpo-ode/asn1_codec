 ...
 */
static asn_oer_constraints_t asn_OER_type_TransitStatus_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
static asn_per_constraints_t asn_PER_type_TransitStatus_constr_1 GCC_NOTUSED = {
