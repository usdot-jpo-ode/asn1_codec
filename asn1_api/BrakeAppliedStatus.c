 ...
 */
static asn_oer_constraints_t asn_OER_type_BrakeAppliedStatus_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	5	/* (SIZE(5..5)) */};
asn_per_constraints_t asn_PER_type_BrakeAppliedStatus_constr_1 GCC_NOTUSED = {
