...
static asn_oer_constraints_t asn_OER_type_regional_constr_3 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_oer_constraints_t asn_OER_memb_regional_constr_3 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_oer_constraints_t asn_OER_type_RestrictionUserType_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_regional_3 = {
	...
	&asn_OER_type_regional_constr_3,
...
asn_TYPE_member_t asn_MBR_RestrictionUserType_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RestrictionUserType, choice.regional),
		...
		&asn_OER_memb_regional_constr_3,
