...
int
HashedId3_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_HashedId3_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
asn_per_constraints_t asn_PER_type_HashedId3_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_HashedId3 = {
	...
	sizeof(asn_DEF_HashedId3_tags_1)
		/sizeof(asn_DEF_HashedId3_tags_1[0]), /* 1 */
	&asn_OER_type_HashedId3_constr_1,
	&asn_PER_type_HashedId3_constr_1,
	0, 0,	/* No members */
