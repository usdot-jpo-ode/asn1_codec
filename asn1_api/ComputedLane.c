...
static asn_oer_constraints_t asn_OER_type_offsetXaxis_constr_3 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_offsetYaxis_constr_6 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_regional_constr_12 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_oer_constraints_t asn_OER_memb_regional_constr_12 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_TYPE_member_t asn_MBR_offsetXaxis_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct offsetXaxis, choice.small),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct offsetXaxis, choice.large),
...
static asn_CHOICE_specifics_t asn_SPC_offsetXaxis_specs_3 = {
	sizeof(struct offsetXaxis),
	offsetof(struct offsetXaxis, _asn_ctx),
	offsetof(struct offsetXaxis, present),
	sizeof(((struct offsetXaxis *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_offsetXaxis_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_OER_type_offsetXaxis_constr_3,
...
static asn_TYPE_member_t asn_MBR_offsetYaxis_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct offsetYaxis, choice.small),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_DrivenLineOffsetSm,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct offsetYaxis, choice.large),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_DrivenLineOffsetLg,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_offsetYaxis_specs_6 = {
	sizeof(struct offsetYaxis),
	offsetof(struct offsetYaxis, _asn_ctx),
	offsetof(struct offsetYaxis, present),
	sizeof(((struct offsetYaxis *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_offsetYaxis_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_OER_type_offsetYaxis_constr_6,
