...
static asn_oer_constraints_t asn_OER_memb_aes128Ccm_constr_2 GCC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
static asn_per_constraints_t asn_PER_memb_aes128Ccm_constr_2 GCC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_type_SymmetricEncryptionKey_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_SymmetricEncryptionKey_constr_1 GCC_NOTUSED = {
