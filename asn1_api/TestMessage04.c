...
static asn_TYPE_member_t asn_MBR_TestMessage04_1[] = {
	{ ATF_POINTER, 2, offsetof(struct TestMessage04, header),
	...
	{ ATF_POINTER, 1, offsetof(struct TestMessage04, regional),
...
static const int asn_MAP_TestMessage04_oms_1[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_TestMessage04_specs_1 = {
	sizeof(struct TestMessage04),
	offsetof(struct TestMessage04, _asn_ctx),
	asn_MAP_TestMessage04_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_TestMessage04_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
