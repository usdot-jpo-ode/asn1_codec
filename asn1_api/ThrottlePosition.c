 ...
 */
static asn_oer_constraints_t asn_OER_type_ThrottlePosition_constr_1 GCC_NOTUSED = {
	{ 1, 1 }	/* (0..200) */,
	-1};
asn_per_constraints_t asn_PER_type_ThrottlePosition_constr_1 GCC_NOTUSED = {
