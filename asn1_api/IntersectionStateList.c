...
static asn_oer_constraints_t asn_OER_type_IntersectionStateList_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
asn_per_constraints_t asn_PER_type_IntersectionStateList_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_IntersectionStateList = {
	...
	sizeof(asn_DEF_IntersectionStateList_tags_1)
		/sizeof(asn_DEF_IntersectionStateList_tags_1[0]), /* 1 */
	&asn_OER_type_IntersectionStateList_constr_1,
