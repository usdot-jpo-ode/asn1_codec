 ...
 */
static asn_oer_constraints_t asn_OER_type_EssSolarRadiation_constr_1 GCC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
asn_per_constraints_t asn_PER_type_EssSolarRadiation_constr_1 GCC_NOTUSED = {
