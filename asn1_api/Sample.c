...
static asn_oer_constraints_t asn_OER_memb_sampleStart_constr_2 GCC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_sampleEnd_constr_3 GCC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_member_t asn_MBR_Sample_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Sample, sampleStart),
		...
		&asn_OER_memb_sampleStart_constr_2,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Sample, sampleEnd),
		...
		&asn_OER_memb_sampleEnd_constr_3,
