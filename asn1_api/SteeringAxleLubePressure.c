 ...
 */
static asn_oer_constraints_t asn_OER_type_SteeringAxleLubePressure_constr_1 GCC_NOTUSED = {
	{ 1, 1 }	/* (0..250) */,
	-1};
asn_per_constraints_t asn_PER_type_SteeringAxleLubePressure_constr_1 GCC_NOTUSED = {
