 ...
 */
static asn_oer_constraints_t asn_OER_type_LaneWidth_constr_1 GCC_NOTUSED = {
	{ 2, 1 }	/* (0..32767) */,
	-1};
asn_per_constraints_t asn_PER_type_LaneWidth_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_LaneWidth = {
	...
	sizeof(asn_DEF_LaneWidth_tags_1)
		/sizeof(asn_DEF_LaneWidth_tags_1[0]), /* 1 */
	&asn_OER_type_LaneWidth_constr_1,
