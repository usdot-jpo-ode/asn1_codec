...
int
VertOffset_B07_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_VertOffset_B07_constr_1 GCC_NOTUSED = {
	{ 1, 0 }	/* (-64..63) */,
	-1};
asn_per_constraints_t asn_PER_type_VertOffset_B07_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_VertOffset_B07 = {
	...
	sizeof(asn_DEF_VertOffset_B07_tags_1)
		/sizeof(asn_DEF_VertOffset_B07_tags_1[0]), /* 1 */
	&asn_OER_type_VertOffset_B07_constr_1,
	&asn_PER_type_VertOffset_B07_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
