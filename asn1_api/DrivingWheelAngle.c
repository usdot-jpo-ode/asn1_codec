 ...
 */
static asn_oer_constraints_t asn_OER_type_DrivingWheelAngle_constr_1 GCC_NOTUSED = {
	{ 1, 0 }	/* (-128..127) */,
	-1};
asn_per_constraints_t asn_PER_type_DrivingWheelAngle_constr_1 GCC_NOTUSED = {
