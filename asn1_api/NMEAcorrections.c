...
static asn_oer_constraints_t asn_OER_type_regional_constr_7 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_oer_constraints_t asn_OER_memb_regional_constr_7 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_TYPE_member_t asn_MBR_NMEAcorrections_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_NMEAcorrections_specs_1 = {
