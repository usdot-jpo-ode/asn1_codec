...
extern asn_INTEGER_specifics_t asn_SPC_IncidentResponseEquipment_specs_1;
...
oer_type_decoder_f IncidentResponseEquipment_decode_oer;
oer_type_encoder_f IncidentResponseEquipment_encode_oer;
