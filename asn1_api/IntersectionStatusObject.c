 ...
 */
static asn_oer_constraints_t asn_OER_type_IntersectionStatusObject_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
asn_per_constraints_t asn_PER_type_IntersectionStatusObject_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_IntersectionStatusObject = {
	...
	sizeof(asn_DEF_IntersectionStatusObject_tags_1)
		/sizeof(asn_DEF_IntersectionStatusObject_tags_1[0]), /* 1 */
	&asn_OER_type_IntersectionStatusObject_constr_1,
