...
int
LinkageValue_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_LinkageValue_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	9	/* (SIZE(9..9)) */};
asn_per_constraints_t asn_PER_type_LinkageValue_constr_1 GCC_NOTUSED = {
