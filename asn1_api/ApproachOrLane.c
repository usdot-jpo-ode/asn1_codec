...
static asn_oer_constraints_t asn_OER_type_ApproachOrLane_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_ApproachOrLane_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_ApproachOrLane_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ApproachOrLane, choice.approach),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ApproachOrLane, choice.lane),
...
asn_TYPE_descriptor_t asn_DEF_ApproachOrLane = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_OER_type_ApproachOrLane_constr_1,
	&asn_PER_type_ApproachOrLane_constr_1,
