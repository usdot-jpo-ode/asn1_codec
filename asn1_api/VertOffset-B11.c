...
int
VertOffset_B11_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_VertOffset_B11_constr_1 GCC_NOTUSED = {
	{ 2, 0 }	/* (-1024..1023) */,
	-1};
asn_per_constraints_t asn_PER_type_VertOffset_B11_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_VertOffset_B11 = {
	...
	sizeof(asn_DEF_VertOffset_B11_tags_1)
		/sizeof(asn_DEF_VertOffset_B11_tags_1[0]), /* 1 */
	&asn_OER_type_VertOffset_B11_constr_1,
