...
int
AddGrpB_Elevation_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_AddGrpB_Elevation_constr_1 GCC_NOTUSED = {
	{ 2, 0 }	/* (-32768..32767) */,
	-1};
asn_per_constraints_t asn_PER_type_AddGrpB_Elevation_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_AddGrpB_Elevation = {
	...
	&asn_PER_type_AddGrpB_Elevation_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
