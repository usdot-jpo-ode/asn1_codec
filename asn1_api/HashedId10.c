...
int
HashedId10_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_HashedId10_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
static asn_per_constraints_t asn_PER_type_HashedId10_constr_1 GCC_NOTUSED = {
