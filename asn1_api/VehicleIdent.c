...
static asn_oer_constraints_t asn_OER_type_vehicleClass_constr_7 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_ownerCode_constr_4 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
...
asn_TYPE_descriptor_t asn_DEF_vehicleClass_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_OER_type_vehicleClass_constr_7,
...
asn_TYPE_member_t asn_MBR_VehicleIdent_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct VehicleIdent, ownerCode),
		...
		&asn_OER_memb_ownerCode_constr_4,
