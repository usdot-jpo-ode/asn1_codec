 ...
 */
static asn_oer_constraints_t asn_OER_type_TireLeakageRate_constr_1 GCC_NOTUSED = {
	{ 2, 1 }	/* (0..64255) */,
	-1};
asn_per_constraints_t asn_PER_type_TireLeakageRate_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_TireLeakageRate = {
	...
	sizeof(asn_DEF_TireLeakageRate_tags_1)
		/sizeof(asn_DEF_TireLeakageRate_tags_1[0]), /* 1 */
	&asn_OER_type_TireLeakageRate_constr_1,
	&asn_PER_type_TireLeakageRate_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
