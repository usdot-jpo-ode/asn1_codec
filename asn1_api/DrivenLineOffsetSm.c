 ...
 */
static asn_oer_constraints_t asn_OER_type_DrivenLineOffsetSm_constr_1 GCC_NOTUSED = {
	{ 2, 0 }	/* (-2047..2047) */,
	-1};
asn_per_constraints_t asn_PER_type_DrivenLineOffsetSm_constr_1 GCC_NOTUSED = {
