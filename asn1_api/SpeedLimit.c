...
static asn_oer_constraints_t asn_OER_type_SpeedLimit_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
asn_per_constraints_t asn_PER_type_SpeedLimit_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
asn_TYPE_descriptor_t asn_DEF_SpeedLimit = {
	...
	sizeof(asn_DEF_SpeedLimit_tags_1)
		/sizeof(asn_DEF_SpeedLimit_tags_1[0]), /* 1 */
	&asn_OER_type_SpeedLimit_constr_1,
