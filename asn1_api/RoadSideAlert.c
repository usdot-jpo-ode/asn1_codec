...
static asn_oer_constraints_t asn_OER_type_description_constr_5 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_description_constr_5 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_description_5 = {
	...
	&asn_OER_type_description_constr_5,
...
asn_TYPE_member_t asn_MBR_RoadSideAlert_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct RoadSideAlert, description),
		...
		&asn_OER_memb_description_constr_5,
