...
static asn_oer_constraints_t asn_OER_type_msgId_constr_4 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_regions_constr_12 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
static asn_oer_constraints_t asn_OER_type_content_constr_16 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_regions_constr_12 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
