 ...
 */
static asn_oer_constraints_t asn_OER_type_ITIScodes_constr_1 GCC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
asn_per_constraints_t asn_PER_type_ITIScodes_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (0..65535) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_ITIScodes_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_ITIScodes = {
	...
	sizeof(asn_DEF_ITIScodes_tags_1)
		/sizeof(asn_DEF_ITIScodes_tags_1[0]), /* 1 */
	&asn_OER_type_ITIScodes_constr_1,
	&asn_PER_type_ITIScodes_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
