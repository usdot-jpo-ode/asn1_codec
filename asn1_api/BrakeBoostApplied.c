 ...
 */
static asn_oer_constraints_t asn_OER_type_BrakeBoostApplied_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_BrakeBoostApplied_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_BrakeBoostApplied_value2enum_1[] = {
	{ 0,	11,	"unavailable" },
	{ 1,	3,	"off" },
	{ 2,	2,	"on" }
};
static const unsigned int asn_MAP_BrakeBoostApplied_enum2value_1[] = {
	1,	/* off(1) */
	2,	/* on(2) */
	0	/* unavailable(0) */
};
const asn_INTEGER_specifics_t asn_SPC_BrakeBoostApplied_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_BrakeBoostApplied_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_BrakeBoostApplied = {
	...
	sizeof(asn_DEF_BrakeBoostApplied_tags_1)
		/sizeof(asn_DEF_BrakeBoostApplied_tags_1[0]), /* 1 */
	&asn_OER_type_BrakeBoostApplied_constr_1,
	&asn_PER_type_BrakeBoostApplied_constr_1,
