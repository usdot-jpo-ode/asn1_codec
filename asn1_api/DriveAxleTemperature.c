 ...
 */
static asn_oer_constraints_t asn_OER_type_DriveAxleTemperature_constr_1 GCC_NOTUSED = {
	{ 2, 0 }	/* (-40..210) */,
	-1};
asn_per_constraints_t asn_PER_type_DriveAxleTemperature_constr_1 GCC_NOTUSED = {
