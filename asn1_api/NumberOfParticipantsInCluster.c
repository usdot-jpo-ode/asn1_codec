 ...
 */
static asn_oer_constraints_t asn_OER_type_NumberOfParticipantsInCluster_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_NumberOfParticipantsInCluster_constr_1 GCC_NOTUSED = {
