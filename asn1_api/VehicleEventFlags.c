...
int
VehicleEventFlags_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_VehicleEventFlags_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
asn_per_constraints_t asn_PER_type_VehicleEventFlags_constr_1 GCC_NOTUSED = {
