 ...
 */
static asn_oer_constraints_t asn_OER_type_SignalReqScheme_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
static asn_per_constraints_t asn_PER_type_SignalReqScheme_constr_1 GCC_NOTUSED = {
