 ...
 */
static asn_oer_constraints_t asn_OER_type_SignPrority_constr_1 GCC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
asn_per_constraints_t asn_PER_type_SignPrority_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_SignPrority = {
	...
	&asn_PER_type_SignPrority_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
