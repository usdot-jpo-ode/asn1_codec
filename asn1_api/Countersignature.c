...
int
Countersignature_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
	...
	td->check_constraints = asn_DEF_Ieee1609Dot2Data.check_constraints;
 ...
 */
static asn_oer_constraints_t asn_OER_type_Countersignature_constr_1 GCC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_Countersignature_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Countersignature = {
	...
	sizeof(asn_DEF_Countersignature_tags_1)
		/sizeof(asn_DEF_Countersignature_tags_1[0]), /* 1 */
	&asn_OER_type_Countersignature_constr_1,
	&asn_PER_type_Countersignature_constr_1,
