...
### **Summary**
The changes for the asn1_codec 1.6.0 release include dockerfile optimizations, a transition to J2735 2020, dockerhub image documentation & a move to including the generated header/implementation files in tracked files as tarballs.
