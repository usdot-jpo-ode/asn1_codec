...
asn1c -fcompound-names -gen-PER -gen-OER -pdu=all 1609dot2-base-types.asn 1609dot2-schema.asn J2735_201603DA.ASN SEMI_v2.3.0_070616.asn 2>&1 | tee compile.out
